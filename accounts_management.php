...
try {
    ...
    $stmt = $pdo->query("
        SELECT 
            ...
            u.role,
            CASE 
                WHEN u.role = 'admin' THEN 'Full Access - Can manage users, products, transaction_log'
                WHEN u.role = 'staff' THEN 'Staff Access - Can manage products, view transaction_log, browse reports'
