...
<body>
    ...
    <header>
        ...
        <a href="<?= ($user['role'] === 'staff') ? 'staff_dashboard.php' : 'customer_dashboard.php' ?>" class="back-btn">⬅ Back to Dashboard</a>
    </header>
                ...
                <table>
                    ...
                    <tbody>
                        <?php foreach ($orders as $order): ?>
                            <?php
                                $rate = isset($currency_rates[$order['currency']]) ? $currency_rates[$order['currency']] : 1;
                                $total_php = $order['total'] * $rate;
                            ?>
                            <tr class="order-row">
                                <td>
                                ...
                                <td>
                                    <span class="amount">₱<?= number_format($total_php, 2) ?></span>
                                </td>
                                <td>
