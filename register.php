...
<body>
    ...
    <div class="register-container">
        ...
        <form method="POST">
            ...
            <select name="role" required style="padding: 0.75rem 1rem; border-radius: 8px; border: none; background: rgba(255,255,255,0.1); color: #f8fafc; font-size: 1rem;">
            ...
            <div class="password-container">
                ...
                <div class="show-password">
                    <input type="checkbox" id="showConfirmPassword" onchange="togglePassword('confirm_password', this)">
                    <label for="showConfirmPassword">Show Password</label>
                </div>
            </div>
            
            <div class="password-requirements">
                <small>Please ensure both passwords match</small>
            </div>
    ...
    <script>
        ...
        function togglePassword(passwordFieldId, checkbox) {
