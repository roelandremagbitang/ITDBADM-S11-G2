...
<body>
    ...
    <a href="admin_order_management.php" class="btn">🧾 Manage Orders</a>
    <a href="#" class="btn" onclick="document.getElementById('profileModal').style.display='block';return false;">👤 Edit Profile</a>
